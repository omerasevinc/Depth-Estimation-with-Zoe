...
class DepthEstimationModel:
    ...
    def initialize_model(self, model_repo="isl-org/ZoeDepth", model_name="ZoeD_N"):
    ...
    def calculate_depthmap(self, image_path, outputpath):
        image = Image.open(image_path).convert("RGB")
        print("Image read.")
        depth_numpy = self.model.infer_pil(image)
        self.save_colored_depth(depth_numpy, outputpath)
        return f"Image saved to {outputpath}"
